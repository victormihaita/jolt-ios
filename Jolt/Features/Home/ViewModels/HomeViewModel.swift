...
class HomeViewModel: ObservableObject {
    ...
    func createReminderFromQuickCapture() async {
        ...
        // TODO: Create reminder via GraphQL mutation
        // For now, just log
        print("Creating reminder: \(parsed.title) due: \(String(describing: parsed.dueDate)) in list: \(defaultList.name)")
