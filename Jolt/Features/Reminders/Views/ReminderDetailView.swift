...
struct ReminderDetailView: View {
    ...
    private var reminder: JoltModels.Reminder? {
        viewModel.reminder
    }

    init(reminder: JoltModels.Reminder) {
    ...
    @ViewBuilder
    private func reminderContent(_ reminder: JoltModels.Reminder) -> some View {
        ScrollView {
    ...
    private func priorityColor(for reminder: JoltModels.Reminder) -> Color {
    ...
    private func formattedDueDate(for reminder: JoltModels.Reminder) -> String {
    ...
    private func formattedSnoozedUntil(for reminder: JoltModels.Reminder) -> String {
    ...
    private func statusIcon(for status: JoltModels.ReminderStatus) -> String {
        switch status {
    ...
    private func statusDisplayName(for status: JoltModels.ReminderStatus) -> String {
        switch status {
    ...
    private func statusColor(for status: JoltModels.ReminderStatus) -> Color {
        switch status {
...
#Preview {
    let previewReminder = JoltModels.Reminder(
        id: UUID(),
