...
public extension PRAPI {
  class DeleteReminderMutation: GraphQLMutation {
    public static let operationName: String = "DeleteReminder"
    public static let operationDocument: ApolloAPI.OperationDocument = .init(
      definition: .init(
        #"mutation DeleteReminder($id: UUID!) { deleteReminder(id: $id) }"#
      ))
    ...
    public struct Data: PRAPI.SelectionSet {
      ...
      public static var __fulfilledFragments: [any ApolloAPI.SelectionSet.Type] { [
        DeleteReminderMutation.Data.self
      ] }

      public var deleteReminder: Bool { __data["deleteReminder"] }
    }
  }
