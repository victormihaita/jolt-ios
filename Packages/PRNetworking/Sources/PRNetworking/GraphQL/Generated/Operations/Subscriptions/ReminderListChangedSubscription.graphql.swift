...
public extension PRAPI {
  class ReminderListChangedSubscription: GraphQLSubscription {
    ...
    public struct Data: PRAPI.SelectionSet {
      ...
      public struct ReminderListChanged: PRAPI.SelectionSet {
        public let __data: DataDict
        public init(_dataDict: DataDict) { __data = _dataDict }

        public static var __parentType: any ApolloAPI.ParentType { PRAPI.Objects.ReminderListChangeEvent }
        public static var __selections: [ApolloAPI.Selection] { [
          .field("__typename", String.self),
          .field("action", GraphQLEnum<PRAPI.ChangeAction>.self),
          .field("reminderListId", PRAPI.UUID.self),
        ...
        public var reminderListId: PRAPI.UUID { __data["reminderListId"] }
