...
public extension PRAPI {
  class ReminderListQuery: GraphQLQuery {
    public static let operationName: String = "ReminderList"
    public static let operationDocument: ApolloAPI.OperationDocument = .init(
      definition: .init(
        #"query ReminderList($id: UUID!) { reminderList(id: $id) { __typename ...ReminderListFragment } }"#,
    ...
    public struct Data: PRAPI.SelectionSet {
      ...
      public static var __selections: [ApolloAPI.Selection] { [
        .field("reminderList", ReminderList?.self, arguments: ["id": .variable("id")]),
      ] }
      public static var __fulfilledFragments: [any ApolloAPI.SelectionSet.Type] { [
        ReminderListQuery.Data.self
      ] }
      ...
      public struct ReminderList: PRAPI.SelectionSet {
        public let __data: DataDict
        public init(_dataDict: DataDict) { __data = _dataDict }
        ...
        public static var __fulfilledFragments: [any ApolloAPI.SelectionSet.Type] { [
          ReminderListQuery.Data.ReminderList.self,
