...
public extension JoltAPI {
  struct ReminderFragment: JoltAPI.SelectionSet, Fragment {
    public static var fragmentDefinition: StaticString {
      #"fragment ReminderFragment on Reminder { __typename id title notes priority dueAt allDay recurrenceRule { __typename frequency interval daysOfWeek dayOfMonth monthOfYear endAfterOccurrences endDate } recurrenceEnd status completedAt snoozedUntil snoozeCount localId version createdAt updatedAt }"#
    }
