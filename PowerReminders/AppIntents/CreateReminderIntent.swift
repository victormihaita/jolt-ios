...
/// App Intent that creates a new reminder in Power Reminders via the GraphQL API.
///
/// Supports Siri phrases like "Create a reminder in Power Reminders" and
...
struct CreateReminderIntent: AppIntent {
    ...
    static var description = IntentDescription(
        "Creates a new reminder in Power Reminders.",
...
/// Maps Power Reminders priority levels to an AppIntents-compatible enum.
